classdef mme_load_pf_tpc < mp.mme_load
% wgv.mme_load_pf_tpc - Math model element for load for TPC power flow.
%
% Math model element class for load elements for TPC power flow problems.
%
