...
%   ``pg1_start``  *double*   initial phase 1 active power (p.u.)
%   ``pg2_start``  *double*   initial phase 2 active power (p.u.)
%   ``pg3_start``  *double*   initial phase 3 active power (p.u.)
%   ``qg1_start``  *double*   initial phase 1 reactive power (p.u.)
%   ``qg2_start``  *double*   initial phase 2 reactive power (p.u.)
%   ``qg3_start``  *double*   initial phase 2 reactive power (p.u.)
%   =============  =========  ========================================
