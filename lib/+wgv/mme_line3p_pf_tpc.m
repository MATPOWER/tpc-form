classdef mme_line3p_pf_tpc < mp.mm_element
% wgv.mme_line3p_pf_tpc - Math model element for 3-phase line for TPC
%                         power flow.
%
% Math model element base class for 3-phase line elements for power flow
% task under the TPC formulation.
%
